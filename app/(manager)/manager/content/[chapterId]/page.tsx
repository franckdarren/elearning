...
import { chapters, classes, subjects, sequences, resources } from "@/lib/db/schema";
import { asc, eq } from "drizzle-orm";
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card";
import { Button } from "@/components/ui/button";
import { ConfirmDialog } from "@/components/shared/confirm-dialog";
import { SequenceDialog } from "@/app/(teacher)/teacher/content/[chapterId]/sequence-dialog";
import { VideoUploadDialog } from "@/app/(teacher)/teacher/content/[chapterId]/video-upload-dialog";
import { DocumentUploadDialog } from "@/app/(teacher)/teacher/content/[chapterId]/document-upload-dialog";
import { ResourceRow } from "@/app/(teacher)/teacher/content/[chapterId]/resource-row";
...
export const metadata = { title: "Gestionnaire · Chapitre" };
...
export default async function ManagerChapterDetailPage({
  params,
}: {
    ...
    <div className="space-y-6">
      <div className="space-y-1">
        <div className="text-sm text-zinc-500">
          <Link
            href={`/manager/content?classId=${chapter.classId}&subjectId=${chapter.subjectId}`}
