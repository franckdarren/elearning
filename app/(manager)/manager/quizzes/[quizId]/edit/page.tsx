...
import { AddQuestionButtons } from "@/app/(teacher)/teacher/quizzes/[quizId]/edit/add-question-buttons";
import { QuestionRow } from "@/app/(teacher)/teacher/quizzes/[quizId]/edit/question-row";

export const metadata = { title: "Gestionnaire · Édition QCM" };
...
export default async function ManagerQuizEditPage({
  params,
}: {
  ...
  // Périmètre établissement (pour le dialogue "Paramètres") + chapitres du quiz.
  const assignments = await getEstablishmentScope(user.establishmentId);
    ...
    <div className="space-y-6">
      <div className="space-y-1">
        <div className="text-sm text-zinc-500">
          <Link href="/manager/quizzes" className="hover:underline">
            ← Liste des QCM
          </Link>
        </div>
        <div className="flex flex-wrap items-start justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button variant="outline" size="sm" asChild>
              <Link href={`/manager/quizzes/${quizId}/preview`}>
