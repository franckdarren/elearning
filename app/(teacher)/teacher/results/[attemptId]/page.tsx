...
export const metadata = { title: "Enseignant · Détail tentative" };
    ...
    const [hit] = await db
      ...
      .where(
        and(
          ...
          eq(teacherAssignments.classId, attempt.classId),
          eq(teacherAssignments.subjectId, attempt.subjectId),
        ),
      )
      .limit(1);
    if (!hit) notFound();
    ...
    <div className="space-y-6">
      <div className="space-y-1">
        <div className="text-sm text-zinc-500">
          <Link href="/teacher/results" className="hover:underline">
            ← Résultats
          </Link>
        </div>
